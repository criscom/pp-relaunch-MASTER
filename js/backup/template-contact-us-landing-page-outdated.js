(function ($) {
  $(document).ready(function() {
    ...
    //Menüanpassung Aktiv setzen von Menüs für Viewsseiten - 21.04.2011
    ...
    //davor für die linke Abrundung div hinzufügen
    $("div.breadcrumb").prepend('<img src="/pedersenandpartners21092012/sites/all/themes/pedersen_einstern_at/images/breadcrumb/breadcrumb_symbol.png" alt="Breadcrumb" /> ');
   ...
   //     $("#block-views-contact-us-block-1 div.content div.view div.view-content div.item-list:nth-child(25n)").wrapAll('<div class="first-column">');
    ...
    // criscom Contac us landing page Listed by country wraps first 25 cities in div and second 25 cities in div 25.10.2012
