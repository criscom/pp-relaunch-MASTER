...
//    $("body.section-regions li.menu-2463 a").addClass("active"); // added by criscom 05.11.2012 ==> Neugestaltung Contact us landing page
    ...
    //$("div.breadcrumb").append('<div class="breadcrumbright"></div>');
 	...
 	// Our offices worldwide Contact Us landing page LISTED ALPHABETICALLY
 
 	$("#block-views-contact-us-block").children("div.content").children("div.view").children("div.view-content").children("div.views-row:lt(21)").wrapAll('<div class="li_group first" />');
 	$("#block-views-contact-us-block").children("div.content").children("div.view").children("div.view-content").children("div.views-row:lt(17)").wrapAll('<div class="li_group second" />');
 	...
 	// criscom Contac us landing page Listed by COUNTRY wraps first 25 cities in div and second 25 cities in div 25.10.2012 adapedet 03.11.2012
  ...
  // criscom 25.10.2012 Contact Us landing page LISTED BY REGION
     ...
     $("#block-views-contact-us-block-2 div.content div.view div.view-content div.view-grouping:nth-child(1)").wrap('<div class="europe-wrapper" />');
     $("#block-views-contact-us-block-2 div.content div.view div.view-content div.view-grouping:nth-child(1)").addClass("europe"); //adds "europe" to class view-grouping
     $("#block-views-contact-us-block-2 div.content div.view div.view-content div.view-grouping:nth-child(2)").addClass("middle-east-africa");
     $("#block-views-contact-us-block-2 div.content div.view div.view-content div.view-grouping:nth-child(3)").addClass("asia");
     $("#block-views-contact-us-block-2 div.content div.view div.view-content div.view-grouping:nth-child(4)").addClass("america");
