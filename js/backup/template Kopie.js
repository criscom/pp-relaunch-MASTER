    ...
    if (window.location.pathname == "/")
    {
    	if (getInternetExplorerVersion() > -1)
    	{
    		$("#worldcarouselslider").crossSlide({sleep: 5, fade: 1, doubleFade:true}, [
  				{ src: '/sites/default/files/public/images/worldmap.gif', href: 'http://pe001ec6.edis.at/regions/world' },
  				{ src: '/sites/default/files/public/map/europe.gif', href: 'http://pe001ec6.edis.at/regions/europe-cis'},
  				{ src: '/sites/default/files/public/map/africa.gif', href: 'http://pe001ec6.edis.at/regions/middle-east-africa'},
  				{ src: '/sites/default/files/public/map/asia.gif', href: 'http://pe001ec6.edis.at/regions/asia' },
  				{ src: '/sites/default/files/public/map/americas.gif', href: 'http://pe001ec6.edis.at/regions/americas' }
			]);
    	}
    	else
    	{
    		$("#worldcarouselslider").crossSlide({sleep: 5, fade: 1, doubleFade:true}, [
  				{ src: '/sites/default/files/public/images/worldmap.png', href: 'http://pe001ec6.edis.at/regions/world' },
  				{ src: '/sites/default/files/public/map/europe.png', href: 'http://pe001ec6.edis.at/regions/europe-cis'},
  				{ src: '/sites/default/files/public/map/africa.png', href: 'http://pe001ec6.edis.at/regions/middle-east-africa'},
  				{ src: '/sites/default/files/public/map/asia.png', href: 'http://pe001ec6.edis.at/regions/asia' },
  				{ src: '/sites/default/files/public/map/americas.png', href: 'http://pe001ec6.edis.at/regions/americas' }
			]);
		}
	}
   });
