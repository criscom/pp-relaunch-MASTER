...
//    $("body.section-regions li.menu-2463 a").addClass("active"); // added by criscom 05.11.2012 ==> Neugestaltung Contact us landing page
    ...
    $("ul.nice-menu > li > a").wrap('<div class="menumiddle" />'); // mittleres Element wird gebraucht!!!! 04.06.2013/01.09.2013
    // davor für die linke Abrundung div hinzufügen
    // criscom 01.09.2013 nice menus redone: $("ul.nice-menu > li").prepend('<div class="menuleft"></div>');
    //danach für die rechte Abrundung div hinzufügen
    // criscom 01.09.2013 nice menus redone:$("ul.nice-menu > li").append('<div class="menuright"></div>');
    //davor für die linke Abrundung div hinzufügen
