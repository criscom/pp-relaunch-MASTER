	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
			...
			if(o.displayThumbnails)
			{
				...
				$('#testbutton_3').bind('click',thumbclick);
				$('#testbutton_3').css({'font-size': '8px'});// We use bind instead of just plain click so that we can repeatedly remove and reattach the handler
